...
python3 train_calibration.py \
    ...
    --data_folder_custom /ws/data/CustomDataset \
    --max_r 5 \
    --max_t 0.5 \
    --epochs 150 \
    ...
    --img_shape 536 960 \
    --save_dir /ws/output  \
    --save_model_name cmrnext_LgInnotek_5_0.5_260403 \
    --dataset lg_innotek  \
    --data_type lg_custom \
    ...
    # --wandb_project cmrnext-calib \
    # --wandb_entity LGIT_calib \
    # --wandb_group lginnotek_fulltrain \
    # --wandb_name cmrnext_lg_full_lidar_G3_r5_t0.5_260403 \
    # --wandb_tags lginnotek,fulltrain,lidar,r5,t0.5 \
